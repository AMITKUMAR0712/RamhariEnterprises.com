    ...
    <section ref={sectionRef} className="w-full h-full py-16 px-6 text-center">
      ...
      <div className="mt-20 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 w-[90%] md:w-5/6 lg:w-4/5 xl:w-5xl 2xl:w-7xl mx-auto text-gray-800">
        <div className="text-center p-4 rounded-lg md:p-0 md:rounded-none">
          ...
          <a href="mailto:jahanzaib@Ramhari Web-Solutionfusion.com" className="text-gray-400 hover:text-gray-200 text-sm">jahanzaib@Ramhari Web-Solutionfusion.com</a>
        </div>
        <div className="text-center p-4 rounded-lg md:p-0 md:rounded-none">
          ...
          <a href="mailto:sales@Ramhari Web-Solutionfusion.com" className="text-gray-400 hover:text-gray-200 text-sm">sales@Ramhari Web-Solutionfusion.com</a>
        </div>
        <div className="text-center p-4 rounded-lg md:p-0 md:rounded-none">
          <h3 className="font-semibold text-white">Technology</h3>
          <p className="text-sm text-gray-400">Questions or queries? Get in touch!</p>
          <a href="mailto:ahmad@Ramhari Web-Solutionfusion.com" className="text-gray-400 hover:text-gray-200 text-sm">ahmad@Ramhari Web-Solutionfusion.com</a>
        </div>
      </div>
    </section>
  );
